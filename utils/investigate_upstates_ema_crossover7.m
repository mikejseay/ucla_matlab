function [ups, downs, up_areas, down_areas] = investigate_upstates_ema_crossover7(v, dt, slow_width, fast_width, ...
...
small_downs = down_areas * dt < down_area_thresh; % delete both current down and subsequent up indices
